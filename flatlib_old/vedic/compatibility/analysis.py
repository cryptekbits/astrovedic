...
def get_compatibility_timeline(chart1, chart2, start_date, end_date):
    ...
    from flatlib.vedic.vimshottari import get_dasha, get_antardasha, get_dasha_lord, get_antardasha_lord
    ...
    from flatlib.vedic.compatibility.dasha.compatibility import calculate_planet_compatibility
